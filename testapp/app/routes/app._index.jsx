          ...
          >
            ...
            >
              <span style={{ fontSize: 12, color: "#52606d" }}>
                If Chrome does not show a microphone prompt here, open the standalone voice page on the app domain.
              </span>
              <button
                type="button"
                onClick={openStandaloneVoice}
                style={{
                  border: "1px solid var(--ui-border)",
                  borderRadius: 999,
                  padding: "6px 10px",
