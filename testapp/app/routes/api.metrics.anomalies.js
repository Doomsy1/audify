...
export function createMetricsAnomaliesLoader({ authenticateAdmin, detect }) {
  return async ({ request }) => {
    ...
    try {
      const result = detect({ metric, range, start, end, tz, windowDays, zThreshold });
...
export const loader = createMetricsAnomaliesLoader({
