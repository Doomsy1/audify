          ...
          >
            ...
            >
              <div style={{ display: "grid", gap: 6 }}>
                ...
                <p style={{ margin: 0, color: "#52606d", fontSize: 14 }}>
                  Standalone voice mode on the app domain. This page uses the same assistant flow, playback, and Backboard status as the embedded experience.
                </p>
            ...
            >
              ...
              <form onSubmit={handleTextSubmit} style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                <label htmlFor="agent-prompt-standalone" style={{ display: "none" }}>
                  Ask the analytics assistant
                </label>
                <input
                  id="agent-prompt-standalone"
                  type="text"
                  value={textInput}
