...
export function createSonifyCompareAction({ authenticateAdmin, renderCompare }) {
  return async ({ request }) => {
    ...
    try {
      const result = renderCompare({ a, b, mapping, render });
...
export const action = createSonifyCompareAction({
  authenticateAdmin: authenticate.admin,
  renderCompare: renderCompareClip,
});
