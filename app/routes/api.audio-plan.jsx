...
import { generateBackboardAudioPlan } from "../lib/audioPlan/backboard.server";
import { computeAudioPlanFeatures, FEATURE_VERSION } from "../lib/audioPlan/features";
import { validateAudioPlanResponse } from "../lib/audioPlan/schema";
...
export const action = async ({ request }) => {
  ...
  const features = computeAudioPlanFeatures({
    xSeries,
    ySeries,
    selectionStart,
    selectionEnd,
  ...
  try {
    const rawPlan = await generateBackboardAudioPlan(promptInput);
    const plan = validateAudioPlanResponse(rawPlan, {
